...
class EthernetClass final {
 public:
  ...
  [[deprecated]] void setRetransmissionCount([[maybe_unused]]uint8_t number) const {}
  [[deprecated]] void setRetransmissionTimeout([[maybe_unused]]uint16_t milliseconds) const {}
